...
const dir = path.join(process.cwd(), 'src/features/courses/polytechnic/nc-it/programming-concepts');
...
for (const file of files) {
  ...
  // Add Lucide icons
  const requiredIcons = ['CheckCircle', 'Rocket', 'Brain', 'FileCode', 'Code', 'Database'];
