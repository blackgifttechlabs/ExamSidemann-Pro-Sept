...
export const LearningOutcome${num}: React.FC = () => {
  ...
  const cardClasses = (borderColor: string) => {
      ...
      <div className="max-w-none space-y-20">
        ...
        <section className="space-y-6">
          ...
          <div className={cardClasses('border-${themeColor}-500')}>
            <h3 className="text-xl font-bold mb-2 flex-items-center gap-2"><ListChecks size={20} /> Advanced Applications</h3>
...
console.log("Updated Preservation Management files!");
