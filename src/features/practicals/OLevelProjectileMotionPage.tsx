...
import ProjectileMotionSim from './o-level/physics-experiments/ProjectileMotion';
import { ExperimentGameHeader } from './common/ExperimentGameChrome';
import { ExperimentSceneGate } from './common/ExperimentSceneLoader';

export const OLevelProjectileMotionPage: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen h-[100dvh] flex flex-col bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <div className="w-full flex-1 min-h-0">
        <ExperimentSceneGate label="Building the projectile range">
          <ProjectileMotionSim
            showPaper={showPaper}
