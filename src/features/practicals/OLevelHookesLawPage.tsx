  ...
  return (
    <div className="w-full h-screen h-[100dvh] flex flex-col bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <div className="w-full flex-1 min-h-0">
        <ExperimentSceneGate label="Zeroing the spring apparatus">
          <HookesLawSim
            showPaper={showPaper}
