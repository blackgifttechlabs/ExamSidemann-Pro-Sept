      ...
      <div className="max-w-none space-y-20">
        ...
        <section className="space-y-6">
          ...
          <div className={cardClasses('purple')}>
            <h3 className="text-xl font-bold mb-2 flex items-center gap-2"><FileSearchIcon size={20} /> 2. Solicitation Documents</h3>
          ...
          <div className={cardClasses('red')}>
            <h3 className="text-xl font-bold mb-2 flex items-center gap-2"><TruckIcon4 size={20} /> 4. Delivery and Receipt Documents</h3>
          ...
          <div className={cardClasses('indigo')}>
            <h3 className="text-xl font-bold mb-2 flex items-center gap-2"><ReceiptIcon size={20} /> 5. Invoice and Payment Documents</h3>
