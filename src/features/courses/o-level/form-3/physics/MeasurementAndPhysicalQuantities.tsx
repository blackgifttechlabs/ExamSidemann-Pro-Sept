  ...
  type DiagramType = 'rounding' | 'bounds' | 'area' | 'density' | 'vectors' | 'circuit' | 'densityBalance' | 'image';
  ...
  interface ScalarVectorCardProps {
  kind: 'scalar' | 'vector';
  title: string;
  question: string;
  description: string;
...
const ScalarVectorCard: React.FC<ScalarVectorCardProps> = ({ kind, title, question, description, examples }) => {
...
export const ScalarVectorTable: React.FC = () => (
  <div className="mb-6 flex flex-col gap-4 sm:flex-row">
    <ScalarVectorCard
      kind="scalar"
      title="Scalar"
      question="How much?"
      description="A scalar tells you the size or amount of something. It does not care about direction."
      examples={['5 metres', '20 seconds', '10 kilograms', '50 km/h', '30°C']}
    />
    <ScalarVectorCard
      kind="vector"
      title="Vector"
      question="How much and which direction?"
      description="A vector tells you the size (magnitude) and the direction."
      examples={['5 m east', '20 m/s north', '10 N west', '30 km/h south']}
    />
  </div>
);

export const ScalarVectorDiffTable: React.FC<{ rows: DiffRow[] }> = ({ rows }) => (
  <div className="mb-6 overflow-hidden rounded-none border border-slate-200">
    <table className="w-full border-collapse text-left">
      <thead>
        <tr>
      ...
      <tbody>
        {rows.map((r, i) => (
          <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
            <td className="border-b border-r border-slate-100 px-4 py-3 align-top leading-relaxed text-slate-700 last:border-0 sm:px-5">
              {r.scalar}
            </td>
            <td className="border-b border-slate-100 px-4 py-3 align-top leading-relaxed text-slate-700 last:border-0 sm:px-5">
              {r.vector}
            </td>
          </tr>
        ))}
...
const resultantVectorKeyframes = `
  @keyframes rvDrawA {
  ...
  @keyframes rvDrawB {
    0%, 22% { opacity: 0; stroke-dashoffset: 160; }
    27% { opacity: 1; }
  ...
  @keyframes rvDrawR {
    0%, 50% { opacity: 0; stroke-dashoffset: 200; }
    55% { opacity: 1; }
...
export const ResultantVectorDiagram: React.FC = () => (
  <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <div className="rounded-xl border border-blue-200 bg-blue-50/40 p-4">
      ...
      <svg viewBox="0 0 300 180" className="h-44 w-full">
        <defs>
          <marker
            id="simpleArrowA"
            viewBox="0 0 10 10"
        ...
        {/* 6 N arrow: 15 px per newton = 90 px */}
        <line
          x1="45"
          y1="110"
          x2="135"
    ...
    <div className="rounded-xl border border-amber-200 bg-amber-50/40 p-4">
      ...
      <svg viewBox="0 0 300 180" className="h-44 w-full">
        ...
        <line
          ...
          stroke="#111827"
          strokeWidth="2"
          markerEnd="url(#simpleArrowBBlue)"
        />
        ...
        <line
          ...
          stroke="#111827"
          strokeWidth="2"
          markerEnd="url(#simpleArrowBAmber)"
        />

        {/* Labels are placed outside the arrows */}
        <text
          x="90"
          y="160"
          textAnchor="middle"
    ...
    <div className="rounded-xl border border-red-200 bg-red-50/40 p-4">
      ...
      <svg viewBox="0 0 300 180" className="h-44 w-full">
        ...
        <line
          ...
          stroke="#111827"
          strokeWidth="3"
          markerEnd="url(#simpleArrowRBlue)"
        />
        ...
        <line
          ...
          stroke="#111827"
          strokeWidth="3"
          markerEnd="url(#simpleArrowRAmber)"
        />

        {/* Resultant = 10 N, using a 6-8-10 triangle */}
        <line
          x1="45"
          y1="140"
          x2="135"
          ...
          stroke="#111827"
          strokeWidth="2"
          markerEnd="url(#simpleArrowRRed)"
        />

        {/* Labels deliberately placed away from the lines */}
        <text
          x="90"
          y="164"
          textAnchor="middle"
    ...
    <div className="rounded-xl border border-emerald-200 bg-emerald-50/40 p-4">
      ...
      <svg viewBox="0 0 300 180" className="h-44 w-full">
        ...
        <line
          ...
          stroke="#111827"
          strokeWidth="2"
          markerEnd="url(#simpleArrowFinal)"
        />

        {/* Angle marker */}

        {/* Labels placed in open spaces */}
        <text
          x="180"
          y="70"
          textAnchor="middle"
...
export const ExampleCard: React.FC<ExampleCardProps> = ({ index, example }) => {
  ...
  /* ---- StrokeText: each character is drawn (stroke outline) then filled with ink, in sequence ---- */

  interface StrokeTextProps {
    text: string;
    onDone?: () => void;
    className?: string;
    speed?: number; // ms between each character starting to draw
  }
      ...
      return (
        <span className="inline-flex items-stretch align-middle">
          <svg
            ...
            className="h-auto w-5 shrink-0 self-stretch overflow-visible"
            aria-hidden="true"
          >
            <path
              d="M1 20 L5 20 L10 33 L23 1"
              fill="none"
              stroke="currentColor"
              strokeWidth="3.2"
              strokeLinecap="round"
  ...
  const CancelLine: React.FC<CancelLineProps> = ({ text }) => {
    ...
    if (parts.length <= 1) {
      return (
        <span
          className="ga-ink inline-block text-xl leading-relaxed text-slate-800 sm:text-2xl"
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      heading: 'Scalars and Vectors — Magnitude and Direction',
          intro:
        'Some measurements only need **a number + a unit** — these are **scalars** (e.g. 5 kg, 20 s). ' +
    ...
    diagram: {
        ...
        alt: 'Scalar quantity vs vector quantity examples',
        bare: true,
      },
      diffTable: [
        { scalar: 'Has a size only — no direction.', vector: 'Has a size AND a direction.' },
        { scalar: 'Examples: mass, distance, speed, time, energy, temperature.', vector: 'Examples: displacement, velocity, acceleration, force, momentum.' },
        { scalar: 'To add two scalars, just add the numbers.', vector: 'To add two vectors, you must also think about direction.' },
        { scalar: '5 kg + 3 kg = 8 kg', vector: '5 N north + 3 N south = 2 N north' },
        { scalar: 'Written as a plain number and unit, e.g. 20 m.', vector: 'Often drawn as an arrow — length shows size, arrowhead shows direction.' },
      ],
      resultantExplainer:
        '**Definition:** A resultant vector is **one vector that shows the combined effect of two or more vectors.**\n' +
        '• It tells us **which way everything is going and how strong the total effect is.**',
      method2: {
      ...
      practice: [
        'Give two examples each of scalar quantities and vector quantities.',
        'A force of 5 N acts north and a force of 12 N acts east on an object. Find the magnitude and direction of the resultant force.',
        'Explain why displacement is a vector but distance is a scalar.',
        'A ship sails 8 km west, then 6 km north. Find its resultant displacement from the starting point.',
      ],
    },
    {
      ...
      intro:
        ...
        'To understand how a circuit works, we use three important quantities: **voltage, current, and resistance**.',
      intro2:
        'These quantities describe what pushes the charge, how much charge flows, and how strongly the circuit opposes that flow.',
      introMore: [
        '**Voltage (V)** is the electrical push that gives energy to each coulomb of charge.',
        '**Current (I)** is the rate at which electric charge flows through a circuit.',
        '**Resistance (R)** is the opposition that makes it harder for charge to flow.',
      ],
      definition:
        ...
        rows: [
          {
            step: 1,
            formula: 'V = W / Q',
            text: 'Voltage (V) is the energy transferred per coulomb of charge. It is the electrical push that moves charge around a circuit.',
          },
          {
            step: 2,
            formula: 'I = Q / t',
            text: 'Current (I) is the rate of flow of electric charge through a circuit.',
          },
          {
            step: 3,
            formula: 'R = V / I',
            text: 'Resistance (R) is the opposition to the flow of current. A higher resistance makes it harder for charge to flow.',
          },
        ],
      },
      method2: {
      ...
      examples: [
        ...
        {
            question: 'A lamp transfers 240 J of energy when 20 C of charge passes through it. Calculate the voltage.',
            steps: [
              'Energy (W) = 240 J.',
              'Charge (Q) = 20 C.',
              'Voltage (V) = W ÷ Q = 240 ÷ 20 = 12 V.',
            ],
            answer: 'V = 12 V',
        },
          {
            question: 'A current of 3 A flows for 4 seconds. Calculate the charge transferred.',
            steps: [
              'Current (I) = 3 A.',
              'Time (t) = 4 s.',
              'Charge (Q) = I × t = 3 × 4 = 12 C.',
            ],
            answer: 'Q = 12 C',
        },
          {
            question: 'A charge of 60 C passes through a circuit in 12 seconds. Calculate the current.',
            steps: [
              'Charge (Q) = 60 C.',
              'Time (t) = 12 s.',
              'Current (I) = Q ÷ t = 60 ÷ 12 = 5 A.',
            ],
            answer: 'I = 5 A',
        },
          {
            question: 'A resistor has a resistance of 6 Ω and a current of 2 A. Calculate the voltage across it.',
            steps: [
              'Resistance (R) = 6 Ω.',
              'Current (I) = 2 A.',
          ...
          {
            question: 'A 24 V supply is connected to a resistor of 8 Ω. Calculate the current.',
            steps: [
              'Voltage (V) = 24 V.',
              'Resistance (R) = 8 Ω.',
              'Current (I) = V ÷ R = 24 ÷ 8 = 3 A.',
            ],
            answer: 'I = 3 A',
        },
          {
            question: 'A resistor carries a current of 0.5 A when connected to a 6 V supply. Calculate its resistance.',
            steps: [
              'Voltage (V) = 6 V.',
              'Current (I) = 0.5 A.',
              'Resistance (R) = V ÷ I = 6 ÷ 0.5 = 12 Ω.',
            ],
            answer: 'R = 12 Ω',
        },
          {
            question: 'A motor is connected to a 9 V battery and has a resistance of 3 Ω. Calculate the current.',
            steps: [
              'Voltage (V) = 9 V.',
              'Resistance (R) = 3 Ω.',
              'Current (I) = V ÷ R = 9 ÷ 3 = 3 A.',
            ],
            answer: 'I = 3 A',
        },
          {
            question: 'A component has a resistance of 15 Ω and carries a current of 0.4 A. Calculate the voltage.',
            steps: [
              'Resistance (R) = 15 Ω.',
              'Current (I) = 0.4 A.',
              'Voltage (V) = I × R = 0.4 × 15 = 6 V.',
            ],
            answer: 'V = 6 V',
        },
      ],
  ...
  const GraphicalMethodDiagram: React.FC<{ step: number }> = ({ step }) => {
    const common = {
      width: 220,
      height: 90,
      viewBox: '0 0 220 90',
    ...
    if (step === 1) {
      return (
        <svg {...common} aria-label="Draw the first vector">
          <defs>
            <marker id="methodArrow1" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#111827" />
            </marker>
          </defs>
          <line x1="25" y1="50" x2="130" y2="50" stroke="#111827" strokeWidth="2" markerEnd="url(#methodArrow1)" />
          <text x="78" y="76" textAnchor="middle" fontSize="13" fontWeight="700" fill="#111827">
            A = 6 N
          </text>
        </svg>
      );
    ...
    if (step === 2) {
      return (
        <svg {...common} aria-label="Place the second vector tip-to-tail">
          <defs>
            <marker id="methodArrow2A" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#111827" />
            </marker>
            <marker id="methodArrow2B" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#111827" />
            </marker>
          </defs>
          <line x1="25" y1="65" x2="115" y2="65" stroke="#111827" strokeWidth="2" markerEnd="url(#methodArrow2A)" />
          <line x1="115" y1="65" x2="115" y2="15" stroke="#111827" strokeWidth="2" markerEnd="url(#methodArrow2B)" />
          <text x="70" y="84" textAnchor="middle" fontSize="12" fontWeight="700" fill="#111827">
            A = 6 N
          </text>
          <text x="130" y="38" fontSize="12" fontWeight="700" fill="#111827">
            B = 8 N
          </text>
        </svg>
      );
    ...
    if (step === 3) {
      return (
        <svg {...common} aria-label="Draw the resultant vector">
          <defs>
            <marker id="methodArrow3A" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#111827" />
            </marker>
            <marker id="methodArrow3B" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#111827" />
            </marker>
            <marker id="methodArrow3R" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="4" markerHeight="4" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#111827" />
            </marker>
          </defs>
          <line x1="25" y1="70" x2="115" y2="70" stroke="#111827" strokeWidth="2" markerEnd="url(#methodArrow3A)" />
          <line x1="115" y1="70" x2="115" y2="18" stroke="#111827" strokeWidth="2" markerEnd="url(#methodArrow3B)" />
          <line x1="25" y1="70" x2="115" y2="18" stroke="#111827" strokeWidth="2" markerEnd="url(#methodArrow3R)" />
          <text x="70" y="87" textAnchor="middle" fontSize="12" fontWeight="700" fill="#111827">
            R = resultant
          </text>
        </svg>
      );
    ...
    return (
      <svg {...common} aria-label="Measure the resultant">
        <defs>
          <marker
            id="methodArrow4"
            viewBox="0 0 10 10"
        ...
        <line
          ...
          stroke="#111827"
          strokeWidth="2"
          markerEnd="url(#methodArrow4)"
        />

        {/* Labels placed away from the arrow */}
        <text
          x="60"
          y="25"
          textAnchor="middle"
    ...
    return (
      <section id={section.id} className="mb-16 scroll-mt-24">
        ...
        <div className="mb-6">
          ...
          {section.id === 'scalars-vectors' && <ScalarVectorTable />}

          {section.diffTable && (
            <div className="mb-6">
              <TitleBanner>Scalar vs Vector — Key Differences</TitleBanner>
              <ScalarVectorDiffTable rows={section.diffTable} />
            </div>
          )}
          ...
          {section.resultantExplainer && (
            <div className="mt-8">
              <TitleBanner>Finding the Resultant Vector</TitleBanner>
              <DefinitionBox text={section.resultantExplainer} />
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 sm:p-5">
                  {section.method2.rows?.map((r, i) => (
                    <StepRow
                      ...
                      step={r.step}
                      formula={r.formula}
                      diagram={section.id === "scalars-vectors" ? <GraphicalMethodDiagram step={Number(r.step)} /> : undefined}
                    >
                      {r.text}
                    </StepRow>
                  ))}
