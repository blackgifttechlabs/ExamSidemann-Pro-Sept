...
const sections: Section[] = [
  {
    ...
    intro:
      'A **machine** is a device that makes work easier by changing the size or direction of a force. Machines allow us to lift heavy loads, move objects, or apply forces more effectively.',
    intro2:
      'In this chapter, we will study three types of simple machines: **levers**, **pulley systems**, and **inclined planes**. We will also learn how to calculate their performance using **mechanical advantage**, **velocity ratio**, and **efficiency**.',
    introMore: [
      '**Mechanical Advantage (MA):** The factor by which a machine multiplies the effort force. MA = Load / Effort.',
      '**Velocity Ratio (VR):** The ratio of the distance moved by the effort to the distance moved by the load. VR = Distance moved by effort / Distance moved by load.',
      '**Efficiency:** The measure of how well a machine converts input energy into useful output energy. Efficiency = (MA / VR) × 100%.',
      'In practice, no machine is 100% efficient because energy is lost due to friction and the weight of moving parts. We can improve efficiency by reducing these losses.',
    ],
    definition:
      'A **simple machine** is a mechanical device that changes the direction or magnitude of a force.\n\n' +
      'The **mechanical advantage** is the ratio of load to effort. The **velocity ratio** is the ratio of distances moved. The **efficiency** tells us how much of the input work is converted to useful output work.',
    method: {
      title: 'Key Relationships for Machines',
      kind: 'steps',
      rows: [
        { step: 1, formula: 'MA = Load / Effort', text: 'Mechanical Advantage — how much the machine multiplies the effort force.' },
        { step: 2, formula: 'VR = d_effort / d_load', text: 'Velocity Ratio — the ratio of distances moved by effort and load.' },
        { step: 3, formula: 'Efficiency = (MA / VR) × 100%', text: 'Efficiency — the percentage of input work that is output as useful work.' },
        { step: 4, formula: 'Work input = Work output + Energy losses', text: 'Energy is lost due to friction and the weight of moving parts.' },
      ],
    },
    method2: {
      title: 'Ways to Improve Efficiency',
      kind: 'rules',
      rules: [
        { rule: 'Lubrication reduces friction between moving parts.', example: 'Using oil or grease on hinges and bearings.' },
        { rule: 'Using ball bearings reduces friction by rolling instead of sliding.', example: 'Bicycle wheel hubs and car axles.' },
        { rule: 'Smoothing surfaces reduces friction.', example: 'Polished metal surfaces in machines.' },
        { rule: 'Reducing the weight of moving parts reduces the energy wasted in lifting them.', example: 'Using lightweight materials like aluminium or plastic.' },
      ],
    },
    keyFormula: {
      label: 'Core formulas:',
      formula: (
        <>
          MA = Load / Effort &nbsp;&nbsp;|&nbsp;&nbsp; VR = d<sub>effort</sub> / d<sub>load</sub> &nbsp;&nbsp;|&nbsp;&nbsp; Efficiency = (MA / VR) × 100%
        </>
      ),
    },
    examples: [
      {
        question: 'A lever is used to lift a load of 200 N with an effort of 50 N. Calculate the mechanical advantage.',
        steps: ['Load = 200 N', 'Effort = 50 N', 'MA = Load / Effort = 200 / 50 = 4'],
        answer: 'MA = 4',
      },
      {
        question: 'A pulley system has a velocity ratio of 3. If the efficiency is 80%, calculate the mechanical advantage.',
        steps: ['VR = 3', 'Efficiency = 80% = 0.80', 'Efficiency = MA / VR → 0.80 = MA / 3 → MA = 0.80 × 3 = 2.4'],
        answer: 'MA = 2.4',
      },
      {
        question: 'In a machine, the effort moves 2 m while the load moves 0.5 m. Calculate the velocity ratio.',
        steps: ['Distance moved by effort = 2 m', 'Distance moved by load = 0.5 m', 'VR = 2 / 0.5 = 4'],
        answer: 'VR = 4',
      },
    ],
    practice: [
      'Define mechanical advantage, velocity ratio, and efficiency.',
      'A machine has a mechanical advantage of 5 and a velocity ratio of 8. Calculate its efficiency.',
      'Explain why machines are never 100% efficient.',
      'List three methods for improving the efficiency of a machine.',
      'A force of 40 N is used to lift a load of 120 N. What is the mechanical advantage?',
    ],
  },
  {
    id: 'levers',
