...
import { MATHS_TOPICS, mathsTopicImage, type MathsTopic } from "./mathsTopics";

/**
 * The maths journey's game board — the twin of the reading topic list.
 *
 * Every game is on screen, playable ones in colour and the rest greyed out,
 * so a child can see where the road goes and a parent can see what is coming.
 */
    ...
    <EcdShell backTo="/ecd/journey">
      <div className="relative z-10 flex w-full flex-1 flex-col items-center px-4 pb-24 pt-[72px] sm:pt-[84px]">
        ...
        <p
          ...
          style={headingFont}
        >
          Counting, adding and finding. Pick a game to play!
        </p>
              ...
              >
                <span className="relative block w-full flex-1 overflow-hidden bg-white">
                  ...
                  {locked ? (
                    ...
                    <span className="absolute bottom-2 right-2 flex h-10 w-10 items-center justify-center rounded-full bg-[#e23fd2] text-white shadow-[0_4px_0_#b3159f] transition-transform group-hover:scale-110 sm:h-12 sm:w-12">
